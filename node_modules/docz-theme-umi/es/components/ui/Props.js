...
})(["background:#f1f1f1;border-radius:0px;color:", ";padding:5px 10px;font-size:16px;font-weight:500;& ~ &{margin-left:5px;}"], get('colors.primary'));
...
})(["flex:1;text-align:left;background:transparent;color:", ";opacity:0.5;"], get('colors.blockquoteColor'));
